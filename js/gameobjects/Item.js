var Item = GameObject.$extend({
    ...
    draw: function(ctx){
        if(this.dead == false){
            ...
            ctx.lineWidth = 3.0;
            line(ctx,this.drawpos.x,this.drawpos.y,this.drawpos.x,this.drawpos.y + 18)
            ctx.lineWidth = 5.0;
            ctx.lineCap = "round"
            line(ctx,this.drawpos.x,this.drawpos.y + 18,this.drawpos.x - 4,this.drawpos.y + 14);
            line(ctx,this.drawpos.x,this.drawpos.y + 18,this.drawpos.x + 4,this.drawpos.y + 14);
            ...
            solidCircle(ctx, this.drawpos.x, this.drawpos.y, 7)
        }
    }
});